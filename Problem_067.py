...
tri = [["23","33","44","81","80","92","93","75","94","88","23","61","39","76","22","03","28","94","32","06","49","65","41","34","18","23","08","47","62","60","03","63","33","13","80","52","31","54","73","43","70","26","16","69","57","87","83","31","03","93","70","81","47","95","77","44","29","68","39","51","56","59","63","07","25","70","07","77","43","53","64","03","94","42","95","39","18","01","66","21","16","97","20","50","90","16","70","10","95","69","29","06","25","61","41","26","15","59","63","35"],
...
for r in range(1,100):	   
	...
	for x in range(length):
		...
		if int(tri[r][v]) + int(tri[r-1][v]) > int(tri[r][v]) + int(tri[r-1][v+1]):
			#print(int(tri[r][v]))
			#print(int(tri[r-1][v]))
			#print(int(tri[r][v]) + int(tri[r-1][v]))
			val = int(tri[r][v]) + int(tri[r-1][v])
			
			new_tri.append(val)
			
		else:
			#print(int(tri[r][v]))
			#print(int(tri[r-1][v+1]))
			#print(int(tri[r][v]) + int(tri[r-1][v+1]))
			val = int(tri[r][v]) + int(tri[r-1][v+1])
